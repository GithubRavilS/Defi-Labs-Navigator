...
if (!ids.includes("rwa")) {
  await sheets.spreadsheets.values.append({
    ...
    requestBody: {
      values: [
        ["rwa", "RWA-активы", "🏛️", "Liquidity pool на Solana (Jupiter Portfolio)", "#C9A227"],
      ],
    },
  });
...
console.log(
  "Share spreadsheet with editor access for:",
  (await auth.getClient()).email || "service account",
);
