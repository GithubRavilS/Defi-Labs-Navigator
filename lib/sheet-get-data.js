...
function parseToolsFromSheet(rows, displayRows, categoryId, startToolId) {
  ...
  for (let r = headerRow + 1; r < rows.length; r++) {
    ...
    const priceMin = unified ? pickRangeValue(r, minPriceCol, rw, displayRows) : pickDisplay(r, minPriceCol, rw) || pick(rw, minPriceCol);
    const priceMax = unified ? pickRangeValue(r, maxPriceCol, rw, displayRows) : pickDisplay(r, maxPriceCol, rw) || pick(rw, maxPriceCol);
